...
const initialCards: Flashcard[] = [
    new Flashcard("What is the capital of France?", "Paris","Eiffel tower",["capitals"]),
    new Flashcard("What is the capital of Georgia?", "Tbilisi","s",["capitals"]),
    new Flashcard("What is the capital of Mauritania?", "Nouakchott","d",["capitals"]),
    new Flashcard("What is the capital of Monaco?", "Monaco","vdz",["capitals"]),
